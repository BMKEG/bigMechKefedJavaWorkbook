...
<!--  
NOTE : WE HAVE EDITED THIS SECTION TO ONLY RETRIEVE THE TEXT FROM THE 
BODY OF THE DOCUMENT, LEAVING OUT THE <front> AND <back> SUBSECTIONS.
PLACING THIS MODIFICATION HERE MAKES IT MUCH EASIER TO CONTROL, SINCE ALL
OTHER PROCESSING IS IDENTICAL.
-->
